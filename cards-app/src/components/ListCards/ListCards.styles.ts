export const Style = {
  ...
  Item: "border border-grey-200 rounded-lg p-4 flex items-center gap-4", 
  CartItemImage: "h-[100px] w-auto rounded-lg object-cover bg-[rgba(0,0,0,0.3)]",
  CartItemInfo: "flex flex-col justify-between",
  CartItemTitle: "text-lg font-semibold text-gray-800",
  CartItemPrice: "text-sm text-green-600 font-semibold mt-1",
  CartItemQuantity: "text-gray-600 font-medium mt-2",
  TotalContainer: "flex justify-between items-center mt-6 border-t pt-4",
